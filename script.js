document.addEventListener("DOMContentLoaded", function()
{
    ...
    function updateImages() {
        ...
        for (let i = 1; i <= 9; i++) {
            ...
            img.src = `images/image${randomIndex}.png`;
        }
    }
    ...
    buttonGen.addEventListener("click", function() {
        ...
        if (attemptCount <= 3) {
            ...
            if (checkWin()) {
                ...
                labelWinner.innerHTML = `${userName.innerHTML}, вітаємо, ви виграли!`;
            } else {
                if(++attemptCount > 3)
                {
                    winnerModal.style.display = "flex";
                    labelWinner.innerHTML = `${userName.innerHTML}, ви не виграли. Спробуйте ще раз!`;
                }
                --attemptCount;
    ...
    buttonOK.addEventListener("click", function()
    {
        ...
        if (inputNickValue == "")
            alert("Обов'язково введіть ім'я");
        else
        {
